...
다음은 GLFW를 본인 컴퓨터의 운영체제(32 bit / 64 bit) 에 알맞게 다운로드 받습니다. 저는 64 bit을 다운로드 받고 진행 합니다.
...
다운로드 받은 `.zip` 파일을 압축 해제 하고 본인이 사용하는 Visual Studio 버전에 맞는 폴더로 들어갑니다. 

예를 들어 Visual Studio 2022 버전을 사용한다면 `lib-vc2022` 폴더 입니다.

![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/022.png){: .align-center}

(C:\Program Files\Microsoft Visual Studio\20xx\Professional\VC\Tools\MSVC\xx.yy.zzzzz)
{: .text-center}

![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/023.png){: .align-center}

위와 같이 Microsoft Visual Studio 폴더 하위의 
