...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/029.png){: .align-center}

```c
#pragma comment(lib, "glfw3.lib")
```

`glfw3.lib`를 추가 종속성(Additional dependencies)에 추가하거나 `#pragma` 전처리기를 이용하여 직접 코드에 추가해줍니다.
...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/033.png){: .align-center}

솔루션이 위치한 폴더에 헤더, 라이브러리, `.dll` 파일을 함께 담아둘 폴더를 만듭니다. 폴더 이름은 GLFW로 지정했습니다.

![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/032.png){: .align-center}
...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/031.png){: .align-center}
...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/030.png){: .align-center}
...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/034.png){: .align-center}
...
![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/035.png){: .align-center}

![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/036.png){: .align-center}

GLFW와 동일하게 설치할 수 있습니다. 공용 폴더에 라이브러리 설치하거나 직접 라이브러리 폴더 경로에 설정해줍시다.

### glewinfo / visualinfo

![ComputerGraphics](/assets/images/Docs/Computer%20Graphics/037.png){: .align-center}
...
`glew32.lib` `opengl32.lib`를 추가 종속성(Additional dependencies)에 추가하거나 `#pragma` 전처리기를 이용하여 직접 코드에 추가해줍니다.
