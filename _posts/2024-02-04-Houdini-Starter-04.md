...
노드로 생성한 데이터들을 Merge 노드를 사용해서 하나로 합쳐줄 때, **노드가 가지고 있는 데이터 타입이 모두 동일**해야 합니다.
...
Blast 노드는 input으로 들어온 그룹 데이터 타입을 Guess from Group으로 추측해서 자동으로 맞춰줄 수도 있지만 복잡한 노드를 설계하게 될 경우 데이터 타입을 명시하는 것이 권장됩니다.
...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/067.png){: .align-center} 
...
먼저 primitives 타입의 그룹을 사용해보기 위해서 platonic solids 노드를 사용하여 다면체들을 씬에 배치했습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/065.png){: .align-center} 

다면체의 면의 갯수에 따라 달라진 primitives 그룹이 생성된 것을 확인 할 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/017.gif){: .align-center} 

Color 노드도 그룹 이름에 따라서 적용할 그룹을 지정해 줄 수 있습니다. \\
Color 노드의 output에 다시 새로운 Color 노드를 연결하면 전체 색상이 변합니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/018.gif){: .align-center} 

그룹을 지정해주면 해당 그룹만 컬러가 변화하는 것을 확인하실 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/019.gif){: .align-center} 

Transform, Subdivision 등등 거의 모든 geometry 노드는 그룹을 지정할 수 있습니다.

지금까지는 개별적으로 생성된 도형들을 그룹으로 묶어줬지만 이번에는 단일 오브젝트 내부에서 그룹을 지어보고자 합니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/068.png){: .align-center} 

예를 들어 박스를 생성했습니다. 박스는 points 8개, primitives 6개로 구성되어 있습니다.
...
위 움짤처럼 Group 노드를 생성한다음 데이터 타입을 primitives 로 정하고 Base Group 탭에서 그룹으로 묶어줄 primitives 의 범위를 설정할 수 있습니다. 단일 오브젝트인 박스 내부에서도 박스를 구성하는 요소들 끼리 그룹을 분류할 수 있는 것입니다.
...
Base Group 또는 Scene View 의 마우스 아이콘을 누르면 Select 모드를 사용 가능합니다. \\
혹은 Scene View 위에 마우스를 두고 **S** 키를 눌러도 Select 모드가 됩니다. \\

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/022.gif){: .align-center} 

Select 모드에서 여러 개의 primitives 를 선택하거나 취소하려면 **Shift** 키를 누르고 왼쪽 클릭으로 선택합니다. 물론 드래그로 선택하는 것도 가능합니다. \\
**ESC** 키를 누르면 Select 모드를 취소할 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/023.gif){: .align-center} 

Select 모드에서 Edges 를 선택하는 방법도 동일합니다. 더블 클릭하면 연결된 Edges 끼리 선택할 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/024.gif){: .align-center} 

반대로 Select 모드에서 먼저 선택을 하고 Group 노드를 만드는 방법도 있습니다. \\
위 처럼 Scene View 에서 Group 노드를 만들어주면 선택한 부분들이 그룹으로 묶여서 생성됩니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/025.gif){: .align-center} 
