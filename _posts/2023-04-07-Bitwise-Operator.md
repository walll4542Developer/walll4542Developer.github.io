...
비트 플래그라는 용어의 어원은 깃발입니다. 깃발을 위로 올리면 켜지고 아래로 내리면 꺼짐을 의미합니다. 깃발의 개념을 정수의 비트로 치환하여 비트가 1이면 on, 0이면 off를 나타내는 것입니다. 여기서 바이트의 개별 비트를 **비트 플래그(bit flag)**라고 합니다.
...
${16*16 = 2^8}$ 이기 때문에 16진수 숫자 2개로 1바이트를 완벽히 표현할 수 있습니다.
