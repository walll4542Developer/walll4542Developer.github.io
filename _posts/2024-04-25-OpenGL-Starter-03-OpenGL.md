...
이런 익스텐션 구조의 특수성 덕분에 그래픽카드 제조사와 개발자들 사이에서 공정한 경쟁이 일어납니다. 

시장에서 성능이 훌륭한 것으로 평가받는 익스텐션이 있고 제조사에서 이를 지원하는 그래픽 카드를 제조한다면 표준을 유지하면서 개발하기 때문에 높은 이식성(portability)을 확보합니다.
