...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/144.png){: .align-center}
...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/071.gif){: .align-center}
...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/072.gif){: .align-center}

다음은 위 이미지처럼 삼각함수의 그래프의 수직, 수평 좌표와 연동되어 움직이는 오브젝트를 만들어 보겠습니다. 

삼각함수를 시각적으로 이해하기 쉽도록 특정 좌표를 잡고 오브젝트를 붙이는 작업입니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/145.png){: .align-center}
