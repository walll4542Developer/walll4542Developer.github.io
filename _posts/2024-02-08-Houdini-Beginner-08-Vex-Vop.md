...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/109.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/105.png){: .align-center}
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/106.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/107.png){: .align-center}

`int b` 를 벡터(vector)에 더한다면 `b`의 정수 부분만큼 벡터의 모든 성분에 같은 값이 더해집니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/108.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/052.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/053.gif){: .align-center}

Vop 노드 내부에서 값을 읽고 쓰기 위해서 먼저 **상수(Constant)** 노드를 만들어줍니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/110.png){: .align-center}

상수 노드를 선택하고 파라미터(Parameter)의 'Constant Type'에서 후디니에서 다룰 수 있는 다양한 종류의 상수를 설정해줄 수 있습니다. 

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/111.png){: .align-center}

`float` 을 선택하고 값을 3으로 설정합니다. 하지만 지금으로서는 아무것도 출력하지 않습니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/112.png){: .align-center}

'const1' 노드의 값을 어트리뷰트(Attribute)로 지정하여 출력하려면 **바인드 익스포트(Bind Export)** 라는 노드를 사용해야 합니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/054.gif){: .align-center}
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/113.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/055.gif){: .align-center}

여타 다른 그래프 에디터 처럼 많은 연산 기능이 노드의 형태로 제공됩니다. 예를 들어 위 이미지 처럼 더하기(Add) 노드가 존재할 뿐만 아니라 상수들 끼리 모든 사칙연산이 가능합니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/114.png){: .align-center}

바인드 익스포트로 출력한 결과 `a`와 `b`의 아웃풋을 가지고 다시 연산을 수행할 수도 있습니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/116.png){: .align-center}

`a`와 `b`를 더하고 이를 다시 바인드 익스포트로 출력하는데, 이때 출력하는 값의 이름을 `a`로 정하면 위와 같이 `a`의 값이 2로 *업데이트* 되는 것을 확인 할 수 있습니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/118.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/056.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/057.gif){: .align-center}
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/119.png){: .align-center}
