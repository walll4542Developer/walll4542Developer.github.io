...
2021년 6월에 출시된 첫번째 FSR 1.0버전의 원리를 간단히 설명드리겠습니다.
원래 해상도 보다 작게 렌더링된 단일 소스 이미지를 안티앨리어싱을 거친 다음 **란초스 리샘플링 알고리즘**을 사용하여 업스케일링하고, 이를 다시 날카롭게 보간하는 샤프닝 필터를 거치는 방식입니다.
