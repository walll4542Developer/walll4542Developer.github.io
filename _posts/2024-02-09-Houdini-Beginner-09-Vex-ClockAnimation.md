...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/120.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/058.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/059.gif){: .align-center}

파라미터에서 'Delete Geometry But Keep the Points' 를 체크해주면 포인트(Point)들만 남습니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/060.gif){: .align-center}

유니폼 스케일(Uniform Scale) 값을 조절하여 시간 단위를 표현할 포인트들의 위치를 분 단위와 겹치지 않도록 배치해줍니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/061.gif){: .align-center}

'Copy to points' 노드를 사용하여 시간 단위를 표현하는 포인트들의 위치에 구(Sphere)를 복제하여 배치해줍니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/122.png){: .align-center}

박스(Box) 노드를 사용하여 시계의 시침을 만들었습니다. 같은 방식으로 분침과 초침을 만들고 트랜스폼(Transform) 노드와 연결해서 시, 분, 초침이 시간에 따라 회전하도록 만들 계획입니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/062.gif){: .align-center}

트랜스폼의 로테이션(Rotation) 에서 `Z`값을 가지고 회전하면 됩니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/123.png){: .align-center}

같은 방식으로 분침과 초침을 만들어 주고 적당히 사이즈를 조절합니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/124.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/125.png){: .align-center}

다음은 우리가 시간을 지정하면 시계가 정확한 시, 분, 초침의 위치를 맞춰서 움직이는 부분을 만들 것입니다. 포인트 노드 하나와 어트리뷰트 랭글(Attribute Wrangle)노드를 준비합니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/127.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/063.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/064.gif){: .align-center}

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/128.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/130.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/129.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/065.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/131.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/066.gif){: .align-center}
