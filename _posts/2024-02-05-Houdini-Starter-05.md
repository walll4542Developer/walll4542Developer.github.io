...
header:
  teaser: /assets/images/Docs/Houdini%20Starter/thumbnail-05.gif
...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/034.gif){: .align-center}

1미터 길이의 선분을 만들고 카브 노드를 연결했습니다. \\
First U 가 시작점, Second U 가 끝점입니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/035.gif){: .align-center}

아까 만든 회전하는 패스에 카브 노드를 연결했습니다. \\
First U 값을 바꾸면 패스의 길이가 변화합니다. 또한 시작점의 포인트 인덱스 넘버가 0번으로 고정되어있는 것을 확인할 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/036.gif){: .align-center}

여기서 포인트 인덱스 0번을 블라스트 노드로 분리해보면 패스를 따라서 포인트가 움직이는 것처럼 보입니다. \\
이를 응용하여 포인트 인덱스 0번에 고정된 오브젝트가 패스를 따라 움직이는 애니메이션을 만들어 줄 수 있을 것 같습니다.


![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/037.gif){: .align-center}

반대로 Second U 를 사용하면 끝점의 포인트 인덱스가 계속 변하는 것을 볼 수 있습니다. \\
이를 방지하기 위해서는 새로운 노드인 **소트(Sort)** 가 필요합니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/073.png){: .align-center}

소트 노드는 포인트 인덱스를 원하는 순서대로 정렬할 수 있습니다. \\
정렬 방식에서 인덱스를 역순으로 바꿔주는 'Reverse' 를 선택하고 결과를 봅시다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/038.gif){: .align-center}

끝점인 Second U 가 항상 인덱스 0번인 것을 확인 할 수 있습니다. \\
이제 인덱스 0번에 구(Sphere) 오브젝트를 고정해서 애니메이션 해볼 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/074.png){: .align-center}

위와 같이 Copy to points 노드를 사용하면 원하는 포인트 인덱스에 오브젝트를 고정할 수 있습니다.

![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/039.gif){: .align-center}
