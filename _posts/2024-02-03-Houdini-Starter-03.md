...
더하기 노드를 처음 생성하면 Scene view에는 아무 것도 출력되지 않습니다.
...
![Houdini-Starter](/assets/images/Docs/Houdini%20Starter/034.png){: .align-left} 
버튼을 누르면 Scene view에서 포인트 인덱스를 확인할 수 있습니다.
...
선을 만들기 위해서는 더하기 노드가 하나 더 필요합니다. 더하기 노드를 하나 생성하고 merge의 output에 연결해줍시다.
...
포인트 인덱스를 위 이미지와 같이 **시계방향**으로 맞춰주겠습니다. 포인트 인덱스의 순서는 0-3-2-1으로 **시계방향** 입니다. 
