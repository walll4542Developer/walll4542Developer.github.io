...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/172.png){: .align-center}

먼저 위와 같은 구성으로 노드를 준비합니다. 'add1' 이 생성할 포인트이며 'add2'는 포인트의 속도 파라미터(parameter)를 담당할 것입니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/130.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/173.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/175.png){: .align-center}

이번에는 포인트 한 개를 생성하는 것이 아니라 여러개의 포인트를 생성해서 내가 원하는 타이밍에 원하는 방향으로 이동하도록 하고 싶습니다. 

이를 위해서 **스위치(Switch) 노드**를 사용할 것입니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/174.png){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/131.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/132.gif){: .align-center}

위 이미지 처럼 현재 프레임이 ${15}$일 경우 'add2'의 정보를 가진 포인트가 하나 추가됩니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/176.png){: .align-center}

```hlsl
($FF == 15) || ($FF == 21)
```

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/177.png){: .align-center}

그래서 'add1'에 꼭 포인트를 생성하지 않아도 됩니다. 위 처럼 또는(or) ${\mid\mid}$ 조건문을 사용하여 원하는 갯수의 포인트를 생성한 다음 머지(merge) 노드를 사용하여 추가할 수 있습니다.

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/133.gif){: .align-center}
...
![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/134.gif){: .align-center}

![Houdini-Beginner](/assets/images/Docs/Houdini%20Beginner/178.png){: .align-center}
