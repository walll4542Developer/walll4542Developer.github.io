#ifndef UNIVERSAL_SIMPLE_LIT_DISSOLVE_PASS_INCLUDED
#define UNIVERSAL_SIMPLE_LIT_DISSOLVE_PASS_INCLUDED
...
struct Varyings
{
    ...
    half3 normalWS                  : TEXCOORD4;    // xyz: normal, w: viewDir.x
...
half4 LitPassFragmentSimple(Varyings input, FRONT_FACE_TYPE isFacing : FRONT_FACE_SEMANTIC) : SV_Target
{
    ...
    //Half Subtractive 라이팅
        ...
        color = UniversalFragmentLightCustomBaked(inputData, diffuse, specular, smoothness, emission, alpha, /* normalTS */ half3(0, 0, 1), /*shadowDimming*/ 0, /*rampY*/ _RampY, _BackfaceReceiveShadowOff, isFacing, _BackFaceNormalturn);
    #else
        color = UniversalFragmentLightCustom(inputData, diffuse, specular, smoothness, emission, alpha, /* normalTS */ half3(0, 0, 1), /*shadowDimming*/ 0, /*rampY*/ _RampY, _BackfaceReceiveShadowOff, isFacing, _BackFaceNormalturn);
    #endif
...
#endif // UNIVERSAL_SIMPLE_LIT_DISSOLVE_PASS_INCLUDED
