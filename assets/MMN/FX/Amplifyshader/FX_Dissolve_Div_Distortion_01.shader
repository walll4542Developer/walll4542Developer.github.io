...
Shader "MMN/FX/Amplify shader/FX_Dissolve_Div_Distortion_01"
{
	Properties
	{
		...
		[Header(Vertex Texture)][Space()]_VertexTex("VertexTex", 2D) = "black" {}
		_Vertex_X_Speed("Vertex_X_Speed", Float) = 1
		_Vertex_Y_Speed("Vertex_Y_Speed", Float) = 1
		_VertexTwist("Vertex Twist", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings vert(Attributes input)
			{
				...
				float2 appendResult174 = (float2(_Vertex_X_Speed , _Vertex_Y_Speed));
				float2 uv_VertexTex = input.texcoord.xy * _VertexTex_ST.xy + _VertexTex_ST.zw;
				float2 appendResult168 = (float2(uv_VertexTex.x , ( uv_VertexTex.y + ( uv_VertexTex.x * _VertexTwist ) )));
				float2 panner167 = ( ( frac( ( _TimeParameters.x * 0.001 ) ) * 1000.0 ) * appendResult174 + appendResult168);
				float2 texCoord166 = input.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( tex2Dlod( _VertexTex, float4( panner167, 0, 0.0) ).g * texCoord166.x * input.ase_texcoord1.x * input.normalOS * _VertexPower );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			float4 frag(Varyings input) : SV_Target
			{
				...
				float temp_output_118_0 = ( tex2D( _NoiseTex, panner112 ).g + _Distortion_Offset );
				...
				float lerpResult181 = lerp( input.uv0.z , ( 1.0 - input.ase_color.a ) , _Use_Dissolve_Alpha);
				float temp_output_135_0 = ( lerpResult133 - lerpResult181 );
				...
				float lerpResult186 = lerp( input.ase_color.a , 1.0 , _Use_Dissolve_Alpha);
				float4 appendResult32_g7 = (float4(( _Intensity_Color * lerpResult151 * input.ase_color ).rgb , ( ( (lerpResult144).a * saturate( ( ( temp_output_135_0 / ( 1.0 - lerpResult181 ) ) * _Intensity_Alpha ) ) * lerpResult186 ) * saturate( _EffectAlpha ) )));
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-3776,-304;Inherit;False;Property;_Twist;Twist;22;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-3536,176;Inherit;False;Property;_Noise_Y_Speed;Noise_Y_Speed;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;107;-3472,-352;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;108;-3536,96;Inherit;False;Property;_Noise_X_Speed;Noise_X_Speed;20;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;114;-2976,-32;Inherit;True;Property;_NoiseTex;NoiseTex;19;0;Create;True;0;0;0;False;2;Header(Noise Texture);Space();False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-2672,-32;Inherit;False;Property;_Distortion_X_Power;Distortion_X_Power;24;0;Create;True;0;0;0;False;2;Header(Distortion);Space();False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;123;-2416,496;Inherit;True;Property;_MaskTex;MaskTex;23;0;Create;True;0;0;0;False;2;Header(Mask Texture);Space();False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;129;-1712.084,176;Inherit;False;886.3239;507.2675;CustomData Dissolve_Divide;8;143;185;184;131;180;181;141;135;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-1472,-496;Inherit;False;Property;_Color_Offset;Color_Offset;35;0;Create;True;0;0;0;False;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;136;-1280,-384;Inherit;False;Property;_Color_Range;Color_Range;36;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;142;-1040,-896;Inherit;False;Property;_SubColor;Sub Color;34;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;140;-1040,-688;Inherit;False;Property;_MainColor;Main Color;33;0;Create;True;0;0;0;False;0;False;0.5019608,0.5019608,0.5019608,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;152;-304,-512;Inherit;False;Property;_Intensity_Color;Intensity_Color;39;0;Create;True;0;0;0;False;2;Header(Intensity);Space();False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;345.8473,146.6021;Inherit;False;Property;_CullMode;Cull Mode;42;2;[HideInInspector];[Enum];Fetch;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;160;352,224;Inherit;False;Property;_ZTest;Z Test;37;2;[HideInInspector];[Enum];Fetch;True;0;2;Default;2;Always;6;1;UnityEngine.Rendering.CompareFunction;True;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;344.8473,66.60173;Inherit;False;Property;_BlendDst;Blend Dst;41;2;[HideInInspector];[Enum];Fetch;True;0;1;UnityEngineRenderingBlendMode;0;1;UnityEngine.Rendering.BlendMode;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;345.8473,-13.39828;Inherit;False;Property;_BlendSrc;Blend Src;38;2;[HideInInspector];[Enum];Fetch;True;0;1;UnityEngineRenderingBlendMode;0;1;UnityEngine.Rendering.BlendMode;True;2;Header(Rendering Options);Space();False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-2673,175;Inherit;False;Property;_Distortion_Y_Power;Distortion_Y_Power;25;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-1216,-144;Inherit;False;Property;_ColorGradation;Color Gradation;32;1;[Enum];Create;True;2;Header(Color);Space();2;Alpha;0;UV;1;0;False;2;Header(Color);Space();False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-2880,192;Inherit;False;Property;_Distortion_Offset;Distortion_Offset;26;0;Create;True;0;0;0;False;1;Space(10);False;-0.5;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;135;-1120,224;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;141;-1120,336;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;181;-1264,304;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;164;-128,992;Inherit;False;5;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;165;-608,1296;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;166;-608,1168;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;167;-912,944;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;168;-1088,944;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;169;-1232,1040;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;170;-1392,1104;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;172;-1376,1232;Inherit;False;Property;_Vertex_X_Speed;Vertex_X_Speed;28;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;173;-1376,1312;Inherit;False;Property;_Vertex_Y_Speed;Vertex_Y_Speed;29;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;174;-1152,1232;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;175;-1184,1392;Inherit;False;MMN_Time;-1;;26;0b8d84477b7a4ee4a9eab0aed6158b6e;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;176;-576,1472;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;177;-576,1632;Inherit;True;Property;_VertexPower;VertexPower;31;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;178;-688,944;Inherit;True;Property;_VertexTex;VertexTex;27;0;Create;True;0;0;0;False;2;Header(Vertex Texture);Space();False;-1;None;e0bf2b5b0ce4c8f4f853bf0be9014bac;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;179;-1568,1104;Inherit;False;Property;_VertexTwist;Vertex Twist;30;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;171;-1664,944;Inherit;False;0;178;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;131;-1664,240;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;184;-1456,416;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;185;-1632,416;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;143;-944,240;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;145;-720,352;Inherit;False;Property;_Intensity_Alpha;Intensity_Alpha;40;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;146;-512,240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;150;-368,240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;149;-576,112;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;162;-176,352;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;163;-368,352;Inherit;False;Property;_EffectAlpha;EffectAlpha;43;1;[HideInInspector];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;155;-160,128;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;161;16,128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;186;-128,-96;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;187;-432,-16;Inherit;False;Constant;_Float2;Float 2;29;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;180;-1519,591;Inherit;False;Property;_Use_Dissolve_Alpha;Use_Dissolve_Alpha;18;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;135;1;181;0
WireConnection;141;0;181;0
WireConnection;181;0;131;3
WireConnection;181;1;184;0
WireConnection;181;2;180;0
WireConnection;164;0;178;2
WireConnection;164;1;166;1
WireConnection;164;2;165;1
WireConnection;164;3;176;0
WireConnection;164;4;177;0
WireConnection;167;0;168;0
WireConnection;167;2;174;0
WireConnection;167;1;175;0
WireConnection;168;0;171;1
...
WireConnection;155;2;186;0
WireConnection;161;0;155;0
WireConnection;161;1;162;0
WireConnection;186;0;153;4
WireConnection;186;1;187;0
WireConnection;186;2;180;0
ASEEND*/
//CHKSM=AFF158B8FDC9B7E2FC7E68A80CC71E4CD4218CEC