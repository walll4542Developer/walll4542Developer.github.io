...
Shader "MMN/FX/Amplify shader/FX_BossArea_01"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float localApplySoftParticle80_g30 = ( 0.0 );
				float localApplyLightColor6_g30 = ( 0.0 );
				float localApplyShadowAtten104_g30 = ( 0.0 );
				half localApplyRaycastingAlpha92_g30 = ( 0.0 );
				...
				half4 finalColor92_g30 = appendResult32_g30;
				half3 positionWS92_g30 = input.positionWS;
				float4 screenPos = input.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				half4 screenUV92_g30 = ase_screenPosNorm;
				half4 screenPos92_g30 = ase_screenPosNorm;
				half nearPlane92_g30 = _NearPlaneAlpha;
				half nearPlaneInvertDistance92_g30 = _NearPlaneInvertDistance;
				half raycastHarftoneClip92_g30 = _RaycastHarftoneClip;
				half raycastMinimumAlpha92_g30 = _RaycastMinimumAlpha;
				ApplyRaycastingAlpha( finalColor92_g30 , positionWS92_g30 , screenUV92_g30 , screenPos92_g30 , nearPlane92_g30 , nearPlaneInvertDistance92_g30 , raycastHarftoneClip92_g30 , raycastMinimumAlpha92_g30 );
				float4 finalColor104_g30 = finalColor92_g30;
				float4 shadowCoord104_g30 = input.uv0;
				float3 positionWS104_g30 = input.positionWS;
				float lightRatio104_g30 = _LightRatio;
				ApplyShadowAtten( finalColor104_g30 , shadowCoord104_g30 , positionWS104_g30 , lightRatio104_g30 );
				float4 finalColor6_g30 = finalColor104_g30;
				float3 normalWS6_g30 = input.normalWS;
				float lightRatio6_g30 = _LightRatio;
				ApplyLightColor( finalColor6_g30 , normalWS6_g30 , lightRatio6_g30 );
				float4 finalColor80_g30 = finalColor6_g30;
				float near80_g30 = _SoftParticleNearFadeDistance;
				float far80_g30 = _SoftParticleFarFadeDistance;
				float fadeOutRange80_g30 = _SoftParticleFadeOutRange;
				float localGetPositionCSForBending58_g30 = ( 0.0 );
				float4 positionCS58_g30 = float4( 0,0,0,0 );
				float4 positionNDC58_g30 = float4( 0,0,0,0 );
				float3 positionOS58_g30 = input.positionOS.xyz;
				GetPositionCSForBending( positionCS58_g30 , positionNDC58_g30 , positionOS58_g30 );
				float4 positionNDC80_g30 = positionNDC58_g30;
				ApplySoftParticle( finalColor80_g30 , near80_g30 , far80_g30 , fadeOutRange80_g30 , positionNDC80_g30 );
				float4 break64_g30 = finalColor80_g30;
				...
				float Alpha = ( break64_g30.w * alpha372 );
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-2704,448;Inherit;False;Property;_Distortion_Offset;Distortion_Offset;30;0;Create;True;0;0;0;False;1;Space(10);False;-0.5;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-2533,141;Inherit;False;Property;_Distortion_X_Power;Distortion_X_Power;28;0;Create;True;0;0;0;False;2;Header(Distortion);Space();False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;151;-2384,496;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-2480,416;Inherit;False;Property;_Distortion_Y_Power;Distortion_Y_Power;29;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-1440,240;Inherit;False;Property;_Use_G_Channel_Alpha;Use_G_Channel_Alpha;19;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-1584,-624;Inherit;False;Property;_ColorGradation;Color Gradation;36;1;[Enum];Create;True;2;Header(Color);Space();2;Alpha;0;UV;1;0;False;2;Header(Color);Space();False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1248,-288;Inherit;False;Property;_Color_Offset;Color_Offset;40;0;Create;True;0;0;0;False;1;Space(5);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;29;-928,-768;Inherit;False;Property;_SubColor;Sub Color;38;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0.2479339,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;34;-752,-288;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;35;-928,-560;Inherit;False;Property;_MainColor;Main Color;37;0;Create;True;0;0;0;False;0;False;0.5019608,0.5019608,0.5019608,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CustomExpressionNode;303;463.2715,347.0191;Float;False; ;3;File;0;GetCameraPosition;False;False;0;d2b180d66d3b6594ba4923958c85921a;False;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;137;3248,144;Inherit;False;Property;_ZTest;Z Test;39;2;[HideInInspector];[Enum];Fetch;True;0;2;Default;2;Always;6;1;UnityEngine.Rendering.CompareFunction;True;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;371;2480,-192;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector4Node;364;1072,-576;Inherit;False;Global;_Global_pos;_Global_pos;30;0;Fetch;True;0;0;0;True;0;False;0,0,0,0;76.68392,15.49262,-111.5099,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;381;2400,32;Inherit;False;Property;_Radius;버텍스 밀기의 범위;4;0;Create;False;0;0;0;True;0;False;10;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;121;3216,-304;Float;False;True;-1;2;MM.Client.Editor.ShaderGUI.MMN_FxBlendModeShaderGUI;0;22;MMN/FX/Amplify shader/FX_BossArea_01;308ae98526c03914f8dfddbb03a3d101;True;Unlit;0;0;Unlit;4;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;False;0;False;True;1;0;True;_BlendSrc;0;True;_BlendDst;0;1;False;;0;False;;False;False;False;False;True;False;False;False;False;False;False;False;True;0;True;_CullMode;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;0;True;_ZTest;False;True;0;False;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;2;Include;;False;;Native;False;0;0;;Include;Assets/PatchableAssets/Shaders/MMN/Includes/GlobalTextureHolder.hlsl;False;;Custom;False;0;0;;Off;0;0;Standard;1;Vertex Position;1;0;0;1;True;False;;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;470;-4488.462,-1493.192;Inherit;False;Property;_Noise_UV_pow;Noise_UV_pow;35;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-2640,-272;Inherit;False;Property;_AddNoise_X_Speed;AddNoise_X_Speed;32;0;Create;True;0;0;0;False;0;False;1;-0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2640,-192;Inherit;False;Property;_AddNoise_Y_Speed;AddNoise_Y_Speed;33;0;Create;True;0;0;0;False;0;False;1;-0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;127;-2432,-128;Inherit;False;MMN_Time;-1;;7;0b8d84477b7a4ee4a9eab0aed6158b6e;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;188;-1680,608;Inherit;False;Property;_DefaultValues;Default Values;34;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;387;3055.658,-463.5085;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-1886.392,120.2251;Inherit;True;Property;_MainTex;MainTex;18;0;Create;True;0;0;0;False;3;Header(tcd0.z     Dissolve);Header(Main Texture);Space();False;-1;None;a6aeb5355da7b0d43b94c52a81a5f6a6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-3360,368;Inherit;False;Property;_Noise_X_Speed;Noise_X_Speed;24;0;Create;True;0;0;0;False;0;False;1;-2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;519;1776,1008;Inherit;False;MMN_Time;-1;;7;0b8d84477b7a4ee4a9eab0aed6158b6e;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;518;1616,896;Inherit;False;Property;_Dot_G_Speed;Dot_G_Speed;25;0;Create;True;0;0;0;False;0;False;1;-2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;524;1616,1152;Inherit;False;Property;_Dot_B_Speed;Dot_B_Speed;23;0;Create;True;0;0;0;False;0;False;1;-2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;523;1776,1264;Inherit;False;MMN_Time;-1;;8;0b8d84477b7a4ee4a9eab0aed6158b6e;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;509;1632,624;Inherit;False;Property;_Dot_R_Speed;Dot_R_Speed;26;0;Create;True;0;0;0;False;0;False;1;-2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;510;1792,736;Inherit;False;MMN_Time;-1;;6;0b8d84477b7a4ee4a9eab0aed6158b6e;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;513;2176,608;Inherit;True;Property;_DotTex;DotTex;21;0;Create;True;0;0;0;False;2;Header(Noise Texture);Space();False;-1;None;e1ac02091495a9d4f92c19b48424a482;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5D369A9464B41711FF3388408AACE88841984798