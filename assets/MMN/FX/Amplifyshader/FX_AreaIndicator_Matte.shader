	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag(Varyings input) : SV_Target
			{
				...
				float2 temp_output_34_0_g17 = ( UV869 - temp_cast_1 );
				float2 break39_g17 = temp_output_34_0_g17;
				float2 appendResult50_g17 = (float2(( 1.0 * ( length( temp_output_34_0_g17 ) * 2.0 ) ) , ( ( atan2( break39_g17.x , break39_g17.y ) * ( 1.0 / TWO_PI ) ) * 1.0 )));
				float2 appendResult444 = (float2(appendResult50_g17.x , 1.0));
				...
				float4 break994 = appendResult987;
...
Node;AmplifyShaderEditor.FunctionNode;334;2037.655,364.3489;Inherit;False;Polar Coordinates;-1;;17;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;3;FLOAT2;0;FLOAT;55;FLOAT;56
...
ASEEND*/
//CHKSM=2F29239C7A9FFF6CC76A445443EB4CA079111A1F