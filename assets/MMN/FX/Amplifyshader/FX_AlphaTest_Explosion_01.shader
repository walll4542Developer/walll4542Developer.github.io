...
Shader "MMN/FX/Amplify shader/FX_AlphaTest_Explosion_01"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float localFXFinalColorOutputs125_g18 = ( 0.0 );
				float2 appendResult312 = (float2(_Noise_X_Speed , _Noise_Y_Speed));
				float2 uv_NoiseTex = input.uv0.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw;
				float RandomUV319 = input.ase_texcoord2.w;
				float2 panner313 = ( ( frac( ( _TimeParameters.x * 0.001 ) ) * 1000.0 ) * appendResult312 + ( uv_NoiseTex + RandomUV319 ));
				...
				float3 appendResult316 = (float3(input.uv0.z , input.uv0.w , input.ase_texcoord2.x));
				...
				float fresnelNode366 = ( _Bias + _Scale * pow( max( 1.0 - fresnelNdotV366 , 0.0001 ), _Power ) );
				...
				float Emissive317 = input.ase_texcoord2.y;
				...
				float AlphaClip318 = input.ase_texcoord2.z;
				clip( temp_output_298_0 - AlphaClip318);
				float4 appendResult32_g18 = (float4(lerpResult287.rgb , temp_output_298_0));
				float4 finalColor125_g18 = appendResult32_g18;
				float4 texCoord147_g18 = input.screenPos;
				texCoord147_g18.xy = input.screenPos.xy * float2( 1,1 ) + float2( 0,0 );
				float4 ScreenPos146_g18 = texCoord147_g18;
				float4 positionNDC125_g18 = ScreenPos146_g18;
				float4 texCoord140_g18 = input.fogCoord;
				texCoord140_g18.xy = input.fogCoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 fogCoord139_g18 = texCoord140_g18;
				float4 fogCoord125_g18 = fogCoord139_g18;
				float3 positionWS125_g18 = input.positionWS;
				float3 normalizedWorldNormal = normalize( input.normalWS );
				float3 normalWS125_g18 = normalizedWorldNormal;
				float nearPlaneAlpha125_g18 = _NearPlaneAlpha;
				float nearPlaneInvertDistance125_g18 = _NearPlaneInvertDistance;
				float raycastHarftoneClip125_g18 = _RaycastHarftoneClip;
				float raycastMinimumAlpha125_g18 = _RaycastMinimumAlpha;
				float lightRatio125_g18 = _LightRatio;
				float lightReceive125_g18 = _LightReceive;
				float near125_g18 = _SoftParticleNearFadeDistance;
				float far125_g18 = _SoftParticleFarFadeDistance;
				float fadeOutRange125_g18 = _SoftParticleFadeOutRange;
				float softParticle125_g18 = _SoftParticle;
				float mode125_g18 = _Mode;
				float fogReceive125_g18 = _FogReceive;
				float transitionValue125_g18 = _TransitionValue;
				float spawnTransition125_g18 = _SpawnTransition;
				FXFinalColorOutputs( finalColor125_g18 , positionNDC125_g18 , fogCoord125_g18 , positionWS125_g18 , normalWS125_g18 , nearPlaneAlpha125_g18 , nearPlaneInvertDistance125_g18 , raycastHarftoneClip125_g18 , raycastMinimumAlpha125_g18 , lightRatio125_g18 , lightReceive125_g18 , near125_g18 , far125_g18 , fadeOutRange125_g18 , softParticle125_g18 , mode125_g18 , fogReceive125_g18 , transitionValue125_g18 , spawnTransition125_g18 );
...
Node;AmplifyShaderEditor.CommentaryNode;89;752,48;Inherit;False;195;261;Rendering Options;2;91;99;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;99;768,208;Inherit;False;Property;_ZTest;Z Test;34;2;[HideInInspector];[Enum];Fetch;True;0;2;Default;2;Always;6;1;UnityEngine.Rendering.CompareFunction;True;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;768,112;Inherit;False;Property;_CullMode;Cull Mode;29;1;[Enum];Fetch;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;332;-470.5592,1798.734;Inherit;False;Property;_Main_X_Speed;Main_X_Speed;17;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;333;-470.5592,1878.734;Inherit;False;Property;_Main_Y_Speed;Main_Y_Speed;18;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;334;-487.0692,2193.019;Inherit;False;Property;_Noise_X_Speed;Noise_X_Speed;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;335;-488.0692,2274.018;Inherit;False;Property;_Noise_Y_Speed;Noise_Y_Speed;21;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;336;58.01241,2495.431;Inherit;True;Property;_MaskTex;MaskTex;25;0;Create;True;0;0;0;False;2;Header(Mask Texture);Space();False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;339;67.8279,2053.131;Inherit;True;Property;_NoiseTex;NoiseTex;19;0;Create;True;0;0;0;False;2;Header(Noise Texture);Space();False;-1;None;b9d432b16df585547b51afe19ed41d8a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;365;-1259.225,312.0499;Inherit;False;Property;_Use_Fresnel;Use_Fresnel;26;1;[Toggle];Create;True;0;0;0;False;2;Header(Fresnel);Space();False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;370;-1395.052,122.2966;Inherit;False;Property;_Scale;Scale;28;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;369;-1394.052,41.29694;Inherit;False;Property;_Bias;Bias;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;368;-1375.052,192.2965;Inherit;False;Property;_Power;Power;30;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;330;-1097.706,689.3214;Inherit;False;Property;_Intensity_Alpha;Intensity_Alpha;33;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;331;-898.4199,-152.356;Inherit;False;Property;_Intensity_Color_Emissive;Intensity_Color_Emissive;31;0;Create;True;0;0;0;False;2;Header(Intensity);Space();False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;359;-980.835,-767.6813;Inherit;False;Property;_Intensity_Color_Smoke;Intensity_Color_Smoke;32;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;363;-828.5248,-367.1248;Inherit;False;Property;_Use_WorldLight;Use_WorldLight;22;1;[Toggle];Create;True;0;0;0;False;1;Space();False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;98;729.3865,-109.9986;Float;False;True;-1;2;MM.Client.Editor.ShaderGUI.MMN_FxOpaqueShaderGUI;100;14;MMN/FX/Amplify shader/FX_AlphaTest_Explosion_01;308ae98526c03914f8dfddbb03a3d101;True;Unlit;0;0;Unlit;4;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=TransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;5;False;0;True;True;0;0;True;_BlendSrc;0;True;_BlendDst;0;1;False;;0;False;;False;False;False;False;True;False;False;False;False;False;False;False;True;0;True;_CullMode;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;True;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;1;False;;True;0;True;_ZTest;False;True;0;False;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;;0;1;Above;MMN/FX/AddPass/ShadowCaster;Standard;1;Vertex Position;1;0;0;1;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;362;-243.475,876.0873;Inherit;False;Property;_Vertex_Suckin;Vertex_Suckin;24;0;Create;True;0;0;0;False;0;False;-0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;361;-125.5164,653.1191;Inherit;False;Property;_Vertex_Extrude;Vertex_Extrude;23;0;Create;True;0;0;0;False;2;Header(Vertex Offset);Space();False;0.5;0.59;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;338;89.44193,1670.735;Inherit;True;Property;_MainTex;MainTex;16;0;Create;True;0;0;0;False;2;Header(Main Texture);Space();False;-1;None;b9d432b16df585547b51afe19ed41d8a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FresnelNode;366;-1229.766,50.8759;Inherit;True;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2991F94F8B4FF56457A3C7FE31136884902EB4D2