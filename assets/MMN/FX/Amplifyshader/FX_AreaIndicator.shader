	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag(Varyings input) : SV_Target
			{
				...
				float2 temp_output_34_0_g13 = ( UV869 - temp_cast_4 );
				float2 break39_g13 = temp_output_34_0_g13;
				float2 appendResult50_g13 = (float2(( 1.0 * ( length( temp_output_34_0_g13 ) * 2.0 ) ) , ( ( atan2( break39_g13.x , break39_g13.y ) * ( 1.0 / TWO_PI ) ) * 1.0 )));
				float2 break445 = appendResult50_g13;
				...
				float4 break993 = appendResult987;
...
Node;AmplifyShaderEditor.FunctionNode;334;1424,816;Inherit;False;Polar Coordinates;-1;;13;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;3;FLOAT2;0;FLOAT;55;FLOAT;56
...
Node;AmplifyShaderEditor.RangedFloatNode;1072;6336,-336;Inherit;False;Global;_DimmingFactor;_DimmingFactor;2;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0.06665039;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=32933C3424AA0147E5E2393039D7095D960D562E