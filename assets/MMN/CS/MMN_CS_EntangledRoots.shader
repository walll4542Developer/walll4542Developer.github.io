...
Shader "MMN/CutScene/Entangled Roots"
{
    // Keep properties of StandardSpecular shader for upgrade reasons.
    Properties
    {
        [Header(Entangled Roots Animation)]
        [Space(10)]
        _Cutoff ("Grow Animation", Range(-1.0, 1.0)) = 0
        _Thickness ("Thickness", Range(0.0, 1.0)) = 0
        _ThicknessRange ("Thickness Range", Range(0.0, 1.0)) = 1


        [Header(SimpleLit Shader Options)]
        [Space(10)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/PatchableAssets/Shaders/MMN/CS/MMN_CS_EntangledRootsInput.hlsl"
            #include "Assets/PatchableAssets/Shaders/MMN/CS/MMN_CS_EntangledRootsForwardPass.hlsl"
            ENDHLSL
        }
        ...
        //     #include "Assets/PatchableAssets/Shaders/MMN/BG/MMN_SimpleLitInput.hlsl"
        //     // #include "MMN_SimpleLitDepthNormalsPass.hlsl"
