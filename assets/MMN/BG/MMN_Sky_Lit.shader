    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 LitPassFragmentSimple(Varyings input) : SV_Target
            {
                ...
                float4 color = UniversalFragmentLightCustom(inputData, diffuse, /* specular */0, /* smoothness */0, /* emission */0, alpha, normalTS, /*구름그림자를 안받게한다*/ 1, /*RampY*/0, /* _BackfaceReceiveShadowOff */0, /* FRONT_FACE_TYPE isFacing */0.0, /* float _BackFaceNormalturn */0.0);
