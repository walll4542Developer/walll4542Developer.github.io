...
half4 LitPassFragmentSimple(Varyings input, FRONT_FACE_TYPE isFacing : FRONT_FACE_SEMANTIC) : SV_Target
{
    // UNITY_SETUP_INSTANCE_ID(input);
    ...
    //Half Subtractive 라이팅
        ...
        color = UniversalFragmentLightCustomBaked(inputData, diffuse, specular, smoothness, emission, alpha, /* normalTS */ half3(0, 0, 1), /*shadowDimming*/ 0, /*halfLambertWeight*/ _halfLambertWeight, _BackfaceReceiveShadowOff, isFacing, _BackFaceNormalturn);
    #else
        color = UniversalFragmentLightCustom(inputData, diffuse, specular, smoothness, emission, alpha, /* normalTS */ half3(0, 0, 1), /*shadowDimming*/ 0, /*halfLambertWeight*/ _halfLambertWeight, _BackfaceReceiveShadowOff, isFacing, _BackFaceNormalturn);
    #endif
