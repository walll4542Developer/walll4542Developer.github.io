Shader "MMN/CH/Stockings"
{
    ...
    Subshader
    {
        ...
        Pass
        {
            ...
            #include "Includes/CharacterStockingsPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "MM.Client.Editor.ShaderGUI.CharacterStockingsShaderGUI"
}
