...
Varyings BasePassVertex(Attributes input)
{
    ...
    positionOS = CharacterInflateWidth(positionOS, input.normalOS, _InflateWidth);
#else
...
// 노멀맵에서 NormalTS를 받아오는 경우 - 캐릭터에서는 노멀맵을 사용하지 않기로 함.
// void InitializeCharacterInputData(Varyings input, float3 normalTS, out InputData inputData)
// {
