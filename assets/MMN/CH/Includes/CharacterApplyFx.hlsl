...
void ApplyFx_BeforeFog(inout half3 resultColor, half3 viewDirectionWS, half3 normalWS)
{
...
void ApplyFx_AfterFog(inout half3 resultColor, half3 viewDirectionWS, half3 normalWS)
{
    // NOTE @jihun.song: 순서가 중요하다. 아래에 있을 수록 컬러를 덮어쓴다.
