Shader "MMN/CH/Standard_Merged"
{
    Properties
    {
        ...
        _DyeColor4 ("염색 슬롯 4", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor5 ("염색 슬롯 5", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor6 ("염색 슬롯 6", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor7 ("염색 슬롯 7", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor8 ("염색 슬롯 8", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor9 ("염색 슬롯 9", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor10 ("염색 슬롯 10", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor11 ("염색 슬롯 11", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor12 ("염색 슬롯 12", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor13 ("염색 슬롯 13", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor14 ("염색 슬롯 14", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor15 ("염색 슬롯 15", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor16 ("염색 슬롯 16", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor17 ("염색 슬롯 17", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor18 ("염색 슬롯 18", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor19 ("염색 슬롯 19", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor20 ("염색 슬롯 20", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor21 ("염색 슬롯 21", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor22 ("염색 슬롯 22", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor23 ("염색 슬롯 23", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor24 ("염색 슬롯 24", Color) = (1.0, 1.0, 1.0, 1.0)

        [Header(UV Offset)]
        _UVOffset1 ("UV 오프셋 1", Float) = 0.0
        _UVOffset2 ("UV 오프셋 2", Float) = 1.0
        _UVOffset3 ("UV 오프셋 3", Float) = 1.0
        _UVOffset4 ("UV 오프셋 4", Float) = 1.0
        _UVOffset5 ("UV 오프셋 5", Float) = 1.0
        _UVOffset6 ("UV 오프셋 6", Float) = 1.0
        _UVOffset7 ("UV 오프셋 7", Float) = 1.0
        _UVOffset8 ("UV 오프셋 8", Float) = 1.0
    ...
    HLSLINCLUDE
        ...
        #include "MMN_Character_Standard_Input_Merged.hlsl"
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Includes/CharacterStandardPassMerged.hlsl"
            ENDHLSL
        }
