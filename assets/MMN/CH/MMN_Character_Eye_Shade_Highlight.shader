Shader "MMN/CH/Eye_Shade_Highlight"
{
    Properties
    {
        [Header(Base Map)]
        [Space(10)]
        _BaseMap ("눈꺼풀 음영 맵", 2D) = "white" {}
        _ShadeColor ("색상", Color) = (0.0, 0.0, 0.0, 1.0)
    ...
    SubShader
    {
        Tags
        {
            ...
            // AlphaTest-8 인 이유는 모든 Opaque 오브젝트 보다는 나중에 렌더링 되어야 하고 AlphaTest 이펙트 보다는 먼저 렌더링 되어야 하기 때문입니다.
        ...
        HLSLINCLUDE
            ...
            #include "MMN_Character_Eye_Shade_Highlight_Input.hlsl"
        ENDHLSL
        ...
        Pass
        {
            ...
            #include "Includes/CharacterEyeShadeHighlightPass.hlsl"
            ENDHLSL
        }
