Shader "MMN/CH/Skin_Body/Dissolve"
{
    Properties
    {
        [Header(Skin Texture)]
        ...
        [Space(10)]
        _DyeColor1 ("염색 슬롯 1 (피부)", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor2 ("염색 슬롯 2 (손바닥)", Color) = (1.0, 1.0, 1.0, 1.0)
        _DyeColor3 ("염색 슬롯 3 (예비용)", Color) = (1.0, 1.0, 1.0, 1.0)
        ...
        [Header(Dissolve)]
        [Space(10)]
        [Toggle] _IsDissolve ("디졸브 켜기", Float) = 0.0
        ...
        _DissolvePanningSpeed ("디졸브 패닝 속도", Range(-1.0, 1.0)) = 0.0
        _DissolveMap ("디졸브 텍스쳐", 2D) = "white" { }
        _DissolveTexScale ("디졸브 텍스쳐의 크기", Range(0.1, 10.0)) = 4.0
        [Toggle] _DissolveCutoff ("디졸브 컷오프를 켤까요?", Float) = 1.0
        _DissolveCutoffSmoothness ("컷오프의 부드러움", Range(0.0, 0.5)) = 0.1
    ...
    Subshader
    {
        ...
        HLSLINCLUDE
            ...
            #define _DISSOLVE_FEATURE

            #include "MMN_Character_Skin_Body_Input.hlsl"
        ENDHLSL
        ...
        Pass
        {
            ...
            #include "Includes/CharacterSkinBodyPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "MM.Client.Editor.ShaderGUI.CharacterSkinBodyShaderGUI"
}
